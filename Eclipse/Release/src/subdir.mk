...
src/CutBill.o: /home/carlos/Documentos/Programacion/QBill/src/CutBill.cpp
	...
	g++ -DUNICODE -D_UNICODE -I/usr/include/wx-2.8 -I/usr/lib/x86_64-linux-gnu/wx/include/gtk2-unicode-release-2.8 -O3 -w -c -fmessage-length=0 `wx-config --cxxflags` -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
